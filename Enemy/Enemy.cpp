...
Enemy::Enemy(const char _name[], int _health, int _attack, int _defense, int _speed, int _experience) : Character(_name, _health, _attack, _defense, _speed, false, _experience) {
...
void Enemy::gainExperience(int exp) {
